...
class programa
{
    ...
    /*Creacion de INSERT Tbl_espacio. Insert con metodo PDO
    */
    public function insertar_espacio()
    {
        ...
        $resultado = $datos->execute([
            NULL, $this->nombre_espacio, $this->nombre_alternativo,
            $this->descripcion, $this->cant_personas,  $this->cant_tomas, NULL, $this->comentarios
        ]);
    }

    /*Creacion de SELECT tbl_espacio SELECT con metodo PDO*/
    public function tbl_espacios_creados()
    {
        $pdo = $this->base->abrir_conexion();
        //$datos = $pdo->query("SELECT * FROM tbl_espacio a, tbl_espacio_congreso b where a.id_espacio_pk=b.id_espacio_fk");
        $datos = $pdo->query("SELECT * FROM tbl_espacio");
    ...
    /*Creacion de Insert Tbl_espacio_congreso.Insert con metodo PDO*/
    ...
    {
        /*Creacion de  UPDATE Tabla Espacio.UPDATE con metodo PDOEste query modifica los registros ingresados.*/
        $pdo = $this->base->abrir_conexion();
    ...
    /*Creacion de SELECT TIPO tbl_espacio, SELECT con metodo PDO*/
    ...
    /* Creacion de  DELETE  en la tabla tbl_espacio, con metodo PDO*/
    ...
    /*Creacion de  DELETE  en la tabla tbl_espacio_congresocon metodo PDO*/
    ...
    /*Creacion de Update Tbl_espacio.Update con metodo PDO*/
    ...
    public function inicializar_actividad(
        $idcongreso,
        $nombre_actividad,
        $responsable,
        $hora_inicio,
    ...
    public function pinicializar($nombre_programa, $estado_programa, $descripcion, $creado_por, $fecha_creacion, $modificado_por, $fecha_modificacion)
    {
    ...
    {
        /*Creacion de INSERT tbl_actividad, tbl_actividad_tematica,tbl_congreso_actividad.insert con metodo PDO*/
        $verificador = -1;
        $pdo = $this->base->abrir_conexion();
        ...
        id_tipo_actividad_fk, id_espacio_pk, fecha_actividad, responsable,comentarios)
                VALUES (?,?,?,?,?,?,?,?,?,?)");
        $resultado = $datos->execute([
            NULL, $this->nombre_actividad,  $this->hora_inicio_act,
        ...
        if ($this->idactividad  != 0) {
            ...
            id_actividad_fk, id_linea_investigacion_pk) VALUES (?,?,?)");
                $verificador = $resp->execute([
                    $this->congreso, $this->idactividad,
    ...
    /*Creacion de SELECT select_tematica,SELECT con metodo PDO*/
    ...
    /*Creacion de SELECT TIPO ACTIVIDAD,SELECT con metodo PDO
    */
    ...
    /*Creacion de SELECT ESPACIO ACTIVIDAD,SELECT con metodo PDO
    */
    ...
    /*Creacion de SELECT tbl_actividadesSELECT con metodo PDO*/
    ...
    /*Creacion de listas_de_actividad,SELECT con metodo PDO*/
    function listas_de_actividad(){
        $pdo = $this->base->abrir_conexion();  
    ...
    /*Creacion de funcion auto_completar,SELECT con metodo PDO*/
    function auto_completar($responsable)
    {
        $pdo = $this->base->abrir_conexion();

        $datos = $pdo->query("select * from tbl_usuario a
    ...
    {
        $pdo = $this->base->abrir_conexion();
        return $pdo->query("SELECT MAX(id_espacio_pk) AS id_espacio_pk FROM tbl_espacio");
    }

    public function insertar_actividad_congreso()
    {
        $pdo = $this->base->abrir_conexion();
        //return $pdo->prepare("insert into tbl_espacio_congreso(id_espacio_fk, id_congreso_fk) values (?,?)", "ii", [$this->idespacio,  $this->congreso], true);
        return $pdo->prepare("insert into tbl_espacio_congreso(id_espacio_fk, id_congreso_fk) values (?,?), 'ii'", [$this->idespacio,  $this->congreso], true);
    }
    ...
    /*Creacion de  DELETE  en la tabla tbl_actividadcon metodo PDO*/
    ...
    /*Creacion de  DELETE  en la tabla tbl_congreso_actividad con metodo PDO*/
    ...
    /*Creacion de  DELETE  en la tabla tbl_actividad_tematica con metodo PDO*/
    ...
    public function agregar_distribucion_sesiones_paralelas($distrib)
    {
        $bdd = $this->base->abrir_conexion();
        $result = 0;
        //$result = $bdd->prepare("UPDATE tbl_actividad_tematica SET distribucion_sesiones_paralelas=? WHERE id_tematica_fk=$this->tematica", 'i', [$distrib]);
        $result = $bdd->prepare("UPDATE tbl_actividad_tematica SET distribucion_sesiones_paralelas=? WHERE id_tematica_fk=$this->tematica, 'i'", [$distrib]);
        if ($result != -1) {
            echo 1;
        } else {
    ...
    {
        $bdd = $this->base->abrir_conexion();
        //return $bdd->prepare("delete from tbl_actividad_trabajo where id_actividad_fk=?", 'i', [$this->idactividad]);
        return $bdd->prepare("delete from tbl_actividad_trabajo where id_actividad_fk=?, 'i'", [$this->idactividad]);
    }
    public function insertar_actividad_trabajos()
    {
        $bdd = $this->base->abrir_conexion();
        //return $bdd->prepare("insert into tbl_actividad_trabajo(id_actividad_fk, id_trabajo_fk) values (?,?)", "ii", [$this->idactividad, $this->idtrabajo], true);
        return $bdd->prepare("insert into tbl_actividad_trabajo(id_actividad_fk, id_trabajo_fk) values (?,?), 'ii'", [$this->idactividad, $this->idtrabajo], true);
    }
    public function update_actividad_trabajos()
    {
        $bdd = $this->base->abrir_conexion();
        $result = 0;
        //$result = $bdd->prepare("UPDATE tbl_actividad_trabajo SET id_actividad_fk=? WHERE id_trabajo_fk=$this->idtrabajo", 'i', [$this->idactividad]);
        $result = $bdd->prepare("UPDATE tbl_actividad_trabajo SET id_actividad_fk=? WHERE id_trabajo_fk=$this->idtrabajo, 'i'", [$this->idactividad]);
        if ($result != -1) {
            echo 1;
        } else {
    ...
    /* Creacion de  DELETE  en la tabla tbl_programa_actividad y  tbl_programa con metodo PDO*/
    ...
    /*Creacion de  DELETE  en la tabla tbl_programa_actividad con metodo PDO*/
    ...
    /*Creacion de SELECT  tbl_actividad*/
    ...
    /*Creacion de INSERT  tbl_programa_actividad.Insert con metodo PDO*/
    ...
    /*Creacion de INSERT  Programa.Insert con metodo PDO*/
    public function insertar_programa()
    {
        $pdo = $this->base->abrir_conexion();
        $datos =  $pdo->prepare("INSERT INTO tbl_programa(nombre_programa, estado_programa, 
        descripcion, creado_por, fecha_creacion, modificado_por, fecha_modificacion)
        VALUES (?,?,?,?,?,?,?)");

        $resultado = $datos->execute([
            $this->nombre_programa, $this->estado_programa,
    ...
    public function update_programa()
    {
        ...
        $resultados = $result->execute([
            $this->nombre_programa, $this->estado_programa, $this->descripcion_programa, $this->modificado_por,
    ...
    public function update_programa($id)
        {
            $pdo = $this->base->abrir_conexion();
            $datos = $pdo->prepare("UPDATE tbl_programa SET nombre_programa=?, estado_programa=?,descripcion=?,modificado_por=?,fecha_modificacion=? WHERE id_programa_pk = ?");
            $resultado = $datos->execute([$this->nombre_programa, $this->estado_programa, $this->descripcion, $this->modificado_por, $this->fecha_modificacion,$id]);
            echo $resultado;
        }
    ...
    /*Creacion de tbl_distribucion_tematica SELECT con metodo PDO*/
    ...
    public function tbl_programacreado(){
        ...
        where 1=1");*/
        $datos = $pdo->query("SELECT * FROM tbl_programa");
    ...
    public function eliminarprograma($id){
        $pdo = $this->base->abrir_conexion();
        $datos = $pdo->prepare("DELETE FROM tbl_programa WHERE id_programa_pk=?");
        $resultado =  $datos->execute([$id]);
        echo $resultado;
    }

    /*Creacion de mostrar_tbl_asis_programa SELECT con metodo PDO*/
    ...
    /*Creacion de mostrar_actividad_programaSELECT con metodo PDO*/
...
class itinerario extends programa
{
    ...
    {
        $bdd = $this->base->abrir_conexion();
        //return $bdd->prepare("delete from tbl_usuario_actividad_congreso where id_actividad_fk=? and id_usuario_fk=? and id_congreso_fk=?", 'iii', [$this->idactividad, $this->id_usuario_fk, $this->congreso]);
        return $bdd->prepare("delete from tbl_usuario_actividad_congreso where id_actividad_fk=? and id_usuario_fk=? and id_congreso_fk=?, 'iii'", [$this->idactividad, $this->id_usuario_fk, $this->congreso]);
    }
    ...
    {
        $bdd = $this->base->abrir_conexion();
        //return $bdd->prepare("delete from tbl_usuario_actividad_congreso where id_usuario_fk=? and id_congreso_fk=? and id_actividad_fk=?", 'iii', [$this->id_usuario_fk, $this->congreso, $this->idactividad]);
        return $bdd->prepare("delete from tbl_usuario_actividad_congreso where id_usuario_fk=? and id_congreso_fk=? and id_actividad_fk=?, 'iii'", [$this->id_usuario_fk, $this->congreso, $this->idactividad]);
    }

    /*Creacion de tbl_asis_c_itineraio SELECT con metodo PDO
    */
    ...
    /*Creacion de mostrar_itinerario SELECT con metodo PDO
    */
    ...
    /*Creacion de mostrar_tbl_tipo_actividadSELECT con metodo PDO*/
    ...
    /*Creacion de tbl_asis_c_itineraioSELECT con metodo PDO*/
    ...
    /*Creacion de tbl_usuario_actividad_congreso SELECT con metodo PDO
    */
