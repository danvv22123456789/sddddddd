...
public function mostrar_editar_form_revision($idformulario) {
  ...
  /*Creacion de SELECT tbl_formulario de pantalla ASOCIAR FORMULARIO A TEMÁTICA
    SELECT con metodo PDO
    */
    public function mostrar_form_asociar() {
    ...
    */
    ...
    public function modifica_preguntas_cuanti(){
        $pdo = $this->base->abrir_conexion(); 
        $datos= $pdo->prepare("UPDATE tbl_pregunta_cuantitativa SET nombre_pregunta_cuantitativa=? , opciones=?,
         ponderacion=? where id_pregunta_cuantitativa_pk=?  ,'sssi'");

        $resultado=$datos->execute ([$this->nombre, $this->opcion,
    ...
    public function modifica_preguntas_cuali(){
        $pdo = $this->base->abrir_conexion();
        $datos= $pdo->prepare("update tbl_pregunta_cualitativa set nombre_pregunta_cualitativa=? where id_pregunta_cualitativa_pk=?  ,'si'");
        $resultado=$datos->execute ([$this->nombre,  $this->idtabla]);
