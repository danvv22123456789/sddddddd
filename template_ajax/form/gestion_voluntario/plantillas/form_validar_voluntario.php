	...
	<div class="col-xl-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-validation-2">
			...
			<div class="panel-heading">
				<h4 class="panel-title">Validar Voluntario</h4>
			...
			<div class="panel-body">
				<table id="" name="" class="table table-striped table-bordered align-middle display responsive no-wrap" width="100%">
					<thead>
						<tr>
							<th width="1%">N.</th>
                ...
                <div class="form-group" align="center">
                            <button type="submit"  id="btn_validar_voluntario"class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5">Validar Voluntario</button>
                       </div>
			</div>
			<!-- END panel-body -->
		</div>
