...
<div class="row">
	...
	<div class="col-xl-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <h4 class="panel-title">Subir Trabajo</h4>
			...
			<div class="panel-body">
				<form class="form-horizontal" data-parsley-validate="true" method="POST"   name='form_trabajo'  id='form_trabajo' role="form" role="form">
                ...
                <div class="form-group row mb-3">
						...
						<div class="col-lg-8">
							<select class="form-select"   id="ttrabajo" name="ttrabajo" onchange="valida_tp(this.value);" data-parsley-required="true">
                       ...
                       <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea class="form-control" id="resumen_trabajo" name="resumen_trabajo" rows="2" data-parsley-minlength="20" data-parsley-maxlength="1000" placeholder="Escriba el Resumen del trabajo" data-parsley-required="true"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label class="col-lg-4 col-form-label form-label" for="message">Resumen Abreviado:</label>
                            <div class="col-lg-8">
                                <textarea class="form-control" id="resumen_abreviado" name="resumen_abreviado" rows="2" data-parsley-minlength="20" data-parsley-maxlength="1000" placeholder="Resumen abreviado del trabajo para el programa del congreso" data-parsley-required="true"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label class="col-lg-4 col-form-label form-label" for="message">Palabras Clave:</label>
                            <div class="col-lg-8">
                                <textarea class="form-control" id="palabras_clave" name="palabras_clave" rows="2" data-parsley-minlength="20" data-parsley-maxlength="1000" placeholder=" Palabras claves separadas por coma (palabra,palabra)" data-parsley-required="true"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="form-group row mb-3">
						...
						<div class="col-lg-8">
							<select class="selectpicker form-control multi-select" name="tematicas_trabajo" id="tematicas_trabajo" data-parsley-required="true" multiple>
							</select>
						</div>
					</div>
					...
					<div class="form-group row mb-3" id="premiotrabajo" name="premiotrabajo">
                            ...
                            <div class="col-lg-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tpremio" id="tpremio_si"  value="1"  data-parsley-required="true" />
                                    <label for="tpremio_si">Si</label></input>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tpremio" id="tpremio_no" value="0" checked="true" data-parsley-required="true" />
						...
						<div class="form-group row mb-3" id="revistatrabajo" name="revistatrabajo">
                            ...
                            <div class="col-lg-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="trevista" id="trevista_si"  value="1" data-parsley-required="true" />
                                    <label for="trevista_si">Si</label></input>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="trevista" id="trevista_no" value="0" checked="true" data-parsley-required="true" />
                                    <label for="trevista_no">No</label></input>
                                </div>
                            </div>
                        </div>
                    
                    <!--DUDA CON LOS FORM DE  NÚMERO DE AUTORES-->

                    <div class="form-group row mb-3">
						<label class="col-lg-4 col-form-label form-label">Documento de investigación:</label>
						<div class="col-lg-8">
                        <input type="file" id="archivo_trabajo" name="archivo_trabajo" accept=".odt, .doc, .docx" class="form-control" />
						</div>
					</div>
					...
					<label class="form-label col-form-label col-lg-4">Hora:</label>
						<div class="col-lg-8">
							<div class="input-group bootstrap-timepicker">
								<input id="hora_sugerida" name="hora_sugerida" type="time" class="form-control" placeholder="Hora tentativa de la defensa del trabajo" data-parsley-required="true" />
							</div>
						</div>
					</div>
                ...
                <br>
					<div class="form-group row ">
						...
						<div class="col-lg-8">
							<input type='hidden' name='caso' id='caso' value='crear_trabajo'/>
                            <input type='hidden' name='id' id='id' value=''/>
							<a id="subir_trabajo" onclick="subir_trabajo()" type="submit" class="btn btn-primary">Guardar</a>
...
<script>
	...
	$.getScript('./js/gestion_trabajos/subir_trabajos.js?upd=4');
</script>
<!-- ================== END core-js ================== -->
...
<script>
	...
	$("input[type=number][name=n_autores]").change(function() {
		...
		if ($(this).val()>0) {
			...
			if(num != 0 && num <= limite){
                     $("#frm_coautores").append('<div class="alert alert-warning alert-dismissible fade show text-center"> Seleccionar solo un autor principal en caso de que usted NO lo sea!<br>Se le notificará al autor y deberá aprobar dicha autoría. <button type="button" class="btn-close" data-bs-dismiss="alert"></span></div>');
