$(document).ready(function() {
    ...
    $("form").submit(function() {
        ...
        var url = './includes/fnc_formulario.php?formulario=' + form_id;
        $.ajax({
                    ...
                    if (form_id == 'form_login') {
                        ...
                        if (form_id == 'form_perfil') {
                            if (data == 1 || data == 3) {
                                ...
                                if (data == 0) { alert("Verifique sus datos por favor!"); } else { alert("Ups... Tenemos un problema comuniquese con el administrador"); }
                            }
                        } else {
