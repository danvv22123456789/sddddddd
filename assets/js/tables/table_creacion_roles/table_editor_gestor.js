if ($('#tbl_ieditores_gestores').length !== 0) {
    $('#tbl_ieditores_gestores').DataTable({
        ...
        ajax: {
            "method": "POST",
            "dataType": "json",
            "url": "./includes/fnc_tabs.php?caso=ieditores_gestores"
        ...
        columnDefs: [
            { targets: 4, visible: false },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    <button type="button" title="Información" class='btn btn-outline-secondary btn-xs' onclick='gestion_rol("${data.id_usuario_pk}","7"); return false;'><i class="fa fa-info-circle" style="font-size:10px;"></i></button>`;
                    return botones;
                }
            }
        ],
